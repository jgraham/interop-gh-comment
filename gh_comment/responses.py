REJECT_TEMPLATE = """Thank you for proposing {title} for Interop 2026.
...
ACCEPT_TEMPLATE = """Thank you for proposing {title} for Interop 2026.

We are pleased to let you know that it has been accepted as part of the {focus_area} {type}.

You’ll be able to track progress on this topic throughout the year via the [Interop 2026 dashboard](https://wpt.fyi/interop-2026).
